...
import {BufferAttribute, BufferGeometry, Mesh, MeshStandardMaterial, TextureLoader} from 'three'
import {
    CHUNK_SIZE,
    chunkId,
    Vec3,
...
import {VoxelEnginePlugin} from '../voxelEngineTypes'
import VoxelChunkMesherWorker from './culledMesher.worker.ts?worker'
import {ChunkMeshUpdateMessage, RegisterChunkMessage, RequestChunkMeshUpdateMessage, WorkerMessage} from './type'
import {useVoxelEngine} from '../voxelEngine'
...
export class VoxelChunkMesherSystem extends System {
    ...
    private updateVoxelChunkMesh({id, indices, positions, normals, colors, ambientOcclusion, ...res}: ChunkMeshUpdateMessage) {
        ...
        // // Load the texture
        // const texture = textureLoader.load('aaa.png');
        // // Create a material with the texture
        // const material = new MeshBasicMaterial({ map: texture });
        // // Assign the material to your mesh
        // // voxelChunkMesh.material = material;
